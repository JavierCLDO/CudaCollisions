...
__device__ inline void kernel_on_collision(const size_t o1, const size_t o2, const size_t& n, float const* positions, float const* radius, float* delta_mov, const float& dist_sq)
{
